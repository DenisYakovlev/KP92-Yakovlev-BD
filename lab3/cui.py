...
'''
    ...
    def __init__(self):
        self.controller = Controller(ModelPGSQL(), View())
    ...
    def start(self):
        while(True):
            ...
            if command == 1:
                ...
                table_instance = self.controller.get_class_by_table_name(table_name)
                self.controller.read_columns_of_table(table_instance)
                self.controller.read_items(table_instance)
                ...
                self.controller.update_item(table_instance, id, values)
